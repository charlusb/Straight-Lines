...
## Df full model: 15
##                         Effect df     Chisq p.value
## 1                     straight  1    6.39 *    .012
## 2          planar_intersection  1 17.78 ***   <.001
## 3 straight:planar_intersection  1      0.21    .646
...
mix_all <- mixed(valence~sym_curvcateg+len+straight+planar_intersection+(1+straight+planar_intersection|participant)+(1|object), data=curve_all,family=binomial,check_contrasts=FALSE,method="LRT")   
